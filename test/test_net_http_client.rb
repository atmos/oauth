...
class NetHTTPClientTest < Test::Unit::TestCase
  ...
  def test_that_using_auth_headers_on_get_requests_works_with_plaintext
    ...
    assert_equal 'GET', request.method
    assert_equal '/test?key=value', request.path
    assert_matching_headers "OAuth oauth_nonce=\"225579211881198842005988698334675835446\", oauth_signature_method=\"PLAINTEXT\", oauth_token=\"token_411a7f\", oauth_timestamp=\"1199645624\", oauth_consumer_key=\"consumer_key_86cad9\", oauth_signature=\"1oO2izFav1GP4kEH2EskwXkCRFg%3D\", oauth_version=\"1.0\"", request['authorization']
  end
